...
class input_test(object):
    ...
    def init(self):
        ...
        if (len(port_list) > 0):
            print(port_list[0])
            self.com = serial.Serial(str(port_list[-1]).split(" ")[0], 115200, timeout=5)
    ...
    def run(self):
        ...
        while True:
            ...
            for event in [pygame.event.wait(), ] + pygame.event.get():
                ...
                # print(self.joy[0].axis[0], self.joy[0].axis[1])
                self.com.write(("v 1 " + str(self.joy[0].axis[0] * -200000) + "\n").encode())
                print("v 1 " + str(self.joy[0].axis[0] * -200000) + "\n")
